...
if __name__ == "__main__":
    genMatrix(300, 400, 500, "matrix1.txt", "matrix2.txt")
    os.system("C:/Users/every/source/repos/multithreading/Debug/multithreading.exe")
    print(verify_matmul(read_matrix("matrix1.txt"), read_matrix("matrix2.txt"), read_matrix("res_cpp.txt")))
